...
- [x] Two-step log flow — step 1 selects bean (last-used highlighted as accent card, others listed); step 2 is full log form with bag pre-selected but still editable via dropdown; single-bag users skip step 1
